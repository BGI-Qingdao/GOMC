...
def main():
    try:
        ...
        output_gcf_features_tsv_path = argv[4]
        output_bgc_membership_path = argv[5]
    except:
        print("usage: python perform_l2norm_clustering.py <bigslice_result_folder_query> <bigslice_result_folder_sub> <threshold_0.0-1.4> <output_gcf_features_tsv_path> <output_bgc_membership_path>")
        return 1
