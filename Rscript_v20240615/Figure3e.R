...
# Figure 3e. Line plots show the fractions of genomes coding ARG with (red line) or without (blue line) the presence of Cas operon.
# =================================================================================================================================
...
# Read data
df.ratio <- read.table("data/figure3e.cas_stat.cas_vs_arg.txt", header = TRUE, row.names = 1, sep = "\t") %>%
...
pdf("figs/Figure3e.pdf", width = 10, height = 5, onefile = F)
print(p)
dev.off()