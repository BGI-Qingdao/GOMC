...
# Figure 3b. Barplots display the incidence rate of Cas operon in GOMC genomes with different optimal growth temperatures.
# ==================================================================================================================================
...
pdf("figs/Figure3b.pdf", width = 6, height = 3.5, onefile = F)
print(p)
dev.off()